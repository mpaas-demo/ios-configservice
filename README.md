...
<a name="UgzsB"></a>
## 功能介绍
本 Demo 主要配合官网 [开关配置](https://help.aliyun.com/document_detail/69950.html?spm=a2c4g.11186623.6.946.7f56579ewmCZ5m)，介绍 iOS 动态开关配置能力，功能如下：
...
2. 进入 MPConfigDemo_pod 目录，执行以下命令，拉取依赖库
...
2. 进入 MPConfigDemo_plugin 目录打开工程，点击 “Xcode - Editor - mPaaS - 编辑工程 ” 打开插件面板，切换到“工程概览” TAB，点击安装按钮，拉取依赖。拉取时间比较长，请您耐心等待。
![image.png](http://mpaas-demo.oss-cn-hangzhou.aliyuncs.com/readme_images/1.png)<br />

3. 拉取依赖完成后，您就可以运行此 demo了
4. 此 demo 默认连接 mPaaS 公有云的 Demo 应用，若您需切换到您自己的 App，请重新导入您的 [meta.config 文件](https://tech.antfin.com/docs/2/87321#h2-u4E0Bu8F7Du914Du7F6Eu6587u4EF63)。
